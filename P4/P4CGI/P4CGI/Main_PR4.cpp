...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::mat4(1.0f);
		model = glm::scale(model, glm::vec3(3.0f, 1.5f, 2.5f));
		...
		model = glm::translate(model, glm::vec3(2.0f, -5.0f, -5.5f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		...
		model = glm::translate(model, glm::vec3(0.0f, -2.0f, -5.5f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);

		model = glm::mat4(1.0f);
		model = glm::scale(model, glm::vec3(9.0f, 1.0f, 4.0f));
		model = glm::translate(model, glm::vec3(0.0f, -6.0f, -7.15f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
